...
export default function Dashboard() {
  ...
  useEffect(() => {
    if (!accountId) return;
    fetch(`/api/analytics?accountId=${accountId}`).then(res => res.json()).then(setStats);
    fetch(`/api/equity?accountId=${accountId}`).then(res => res.json()).then(setEquity);
  }, [accountId]);
    ...
    <div className="dashboard">
      <section className="panel top-panel">
        <div className="panel-title">
          <div><small>Account</small><h2>Performance Summary</h2></div>
      ...
      <section className="panel equity-panel">
        <div className="panel-title"><div><small>Growth</small><h2>Equity Curve</h2></div></div>
      ...
      <section className="panel small-panel">
        <div className="panel-title"><div><small>Wins vs Losses</small><h2>Trade Split</h2></div></div>
      ...
      <section className="panel small-panel">
        <div className="panel-title"><div><small>Discipline</small><h2>Journal Rules</h2></div></div>
